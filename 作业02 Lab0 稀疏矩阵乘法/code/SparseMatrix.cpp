...
// const std::map<int, int> SparseMatrix::getRowColMapData(int rowIndex){
//   if(rowColMap.count(rowIndex) == 1){
//     return rowColMap[rowIndex];
//   }
//   std::map<int, int> emptyMap;
//   return emptyMap;
// }

// const std::map<int, int> SparseMatrix::getColRowMapData(int colIndex){
//   if(colRowMap.count(colIndex) == 1){
//     return colRowMap[colIndex];
//   }
//   std::map<int, int> emptyMap;
//   return emptyMap;
// }